...
My cursor started out at the bottom of the java code, so I pressed <up><up><up><up><up><up><up> and <right><right><right><right><right><right><right> to get to the part in line 43 I had to edit. I clicked <delete> and typed <2> to change the variable `index1` to `index2`. The terminal before then after editing are pictured below. 
